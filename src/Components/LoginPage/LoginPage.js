                           ...
                           <div>
                               <div className="loginpage_rightcomponent">
                                ...
                                <div className="loginpage__signupoption">
                                    {
                                        this.state.isLogin ?
                                        <div className="loginPage__signin">
                                                 Don't have an account? <span onClick={this.changeLogin} style={{ "fontWeight":"bold", "color":"#0395F6",cursor:'pointer'}}>Sign up</span>
                                        </div> :
                                ...
                                <div className="loginPage__downloadSection">
                                    ...
                                    <Link href='https://www.apple.com/app-store/'><img  className="loginPage_dwimg" src={appstore} width="136px" /></Link>
                                    <Link href='https://play.google.com/store/games'><img className="loginPage_dwimg" src={playstore} width="136px" /></Link>
                                    </div>
                                </div>
                                </div>
